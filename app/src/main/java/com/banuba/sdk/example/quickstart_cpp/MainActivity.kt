...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        render = EPRenderer(banubaSdk, resPath, BANUBA_CLIENT_TOKEN) { result ->
            runOnUiThread {
...
class EPRenderer(sdk: BanubaSdk, resPath: String, clientToken: String, callback: (Bitmap) -> Unit) : GLSurfaceView.Renderer {

    private val banubaSdk = sdk
    private val completion = callback

    private val effectPlayer: Long = banubaSdk.createEffectPlayer(resPath, clientToken)
