...
class Consts {
    public static final String VERTEX_SHADER_PROGRAM =
            "#version 300 es\n" +
    ...
    public static final String FRAGMENT_SHADER_PROGRAM =
            "#version 300 es\n" +
            "precision mediump float;\n" +
    ...
    public static final String SHADER_FRAG_CONVERSION_CODE =
            "  vec3 rgb = vec3(\n" +
