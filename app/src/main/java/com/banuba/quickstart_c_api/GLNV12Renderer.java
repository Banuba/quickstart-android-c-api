...
import static com.banuba.quickstart_c_api.Consts.FRAGMENT_SHADER_PROGRAM;
import static com.banuba.quickstart_c_api.Consts.SHADER_FRAG_CONVERSION_CODE;
import static com.banuba.quickstart_c_api.Consts.SHADER_VERTEX;
...
public class GLNV12Renderer implements GLSurfaceView.Renderer {
    // clang-format off
...
//            Logger.e("Error linking program: %s", GLES20.glGetProgramInfoLog(programObject));
    ...
    private void create() {
        ...
        try {
            mShaderProgram = new GLShaderProgram(Consts.VERTEX_SHADER_PROGRAM, FRAGMENT_SHADER_PROGRAM);
